...
import Ivory.BSP.STM32.Peripheral.I2Cv1.Peripheral
            ...
            cond_
              [(bitToBool (sr1 #. i2c_sr1_sb)) ==> do
                  ...
                  modifyReg (i2cRegDR periph) $
                    setField i2c_dr_dr (fromRep addr)
